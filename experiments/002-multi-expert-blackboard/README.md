...
Questão / Question: [RQ4](../../research/research-questions.md) · Código / Code: [`software/aisg/blackboard/`](../../software/aisg/blackboard/) · Testes / Tests: [`test_blackboard.py`](../../software/tests/test_blackboard.py)
...
## Cenários e resultados / Scenarios and results

Cenário de 60 nós com 15 sites em duplo acesso (LTE privativo + 900 MHz). / 60-node scenario with 15 dual-homed sites (private LTE + 900 MHz).
